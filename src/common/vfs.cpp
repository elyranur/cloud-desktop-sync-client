...
Vfs::Mode OCC::bestAvailableVfsMode()
{
    ...
    //
    //  * On Linux when our user.elyranur.hydrate_exec is adopted by at least KDE and Gnome
    // the "user.elyranur" prefix might turn into "user.xdg" in the process since it would
