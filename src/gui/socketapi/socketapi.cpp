...
Q_LOGGING_CATEGORY(lcSocketApi, "elyranur.gui.socketapi", QtInfoMsg)
Q_LOGGING_CATEGORY(lcPublicLink, "elyranur.gui.socketapi.publiclink", QtInfoMsg)
...
{
    //listener->sendMessage(QLatin1String("SHARE_MENU_TITLE:") + tr("Share with %1", "parameter is Elyranur").arg(Theme::instance()->appNameGUI()));
...
// Windows Shell / Explorer pinning fallbacks, see issue: https://github.com/elyranur/desktop/issues/1599
#ifdef Q_OS_WIN
