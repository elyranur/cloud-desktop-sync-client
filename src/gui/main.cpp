...
int main(int argc, char **argv)
{
    ...
    qmlRegisterType<EmojiModel>("com.elyranur.desktopclient", 1, 0, "EmojiModel");
    qRegisterMetaTypeStreamOperators<Emoji>();
    qmlRegisterType<UserStatusSelectorModel>("com.elyranur.desktopclient", 1, 0,
        "UserStatusSelectorModel");
    qmlRegisterUncreatableType<OCC::UserStatus>("com.elyranur.desktopclient", 1, 0, "UserStatus",
