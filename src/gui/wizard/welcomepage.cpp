/*
 * Copyright (C) 2021 by Felix Weilbach <felix.weilbach@elyranur.com>
 *
...
void WelcomePage::styleSlideShow()
{
    ...
    const auto wizardElyranurIconFileName = theme->isBranded() ? Theme::hidpiFileName("wizard-elyranur.png", backgroundColor)
                                                                : Theme::hidpiFileName(":/client/theme/colored/wizard-elyranur.png");
    ...
    _ui->slideShow->addSlide(wizardElyranurIconFileName, tr("Keep your data secure and under your control"));
...
void WelcomePage::setupCreateAccountButton()
{
    ...
    connect(_ui->createAccountButton, &QPushButton::clicked, this, [this](bool /*checked*/) {
        _ocWizard->setRegistration(true);
        Utility::openBrowser(QStringLiteral("https://elyranur.com/register"));
    });
...
void WelcomePage::setupHostYourOwnServerLabel()
{
    ...
    _ui->hostYourOwnServerLabel->setUrl(QUrl("https://docs.elyranur.com/server/latest/admin_manual/installation/#installation"));
}
