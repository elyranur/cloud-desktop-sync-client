...
Q_LOGGING_CATEGORY(lcFlow2auth, "elyranur.sync.credentials.flow2auth", QtInfoMsg)
...
void Flow2Auth::fetchNewToken(const TokenAction action)
{
    ...
    // add 'Content-Length: 0' header (see https://github.com/elyranur/desktop/issues/1473)
    QNetworkRequest req;
