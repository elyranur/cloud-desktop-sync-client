...
Q_LOGGING_CATEGORY(lcMoveJob, "elyranur.sync.networkjob.move", QtInfoMsg)
Q_LOGGING_CATEGORY(lcPropagateRemoteMove, "elyranur.sync.propagator.remotemove", QtInfoMsg)
