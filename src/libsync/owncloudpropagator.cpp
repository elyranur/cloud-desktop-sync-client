...
Q_LOGGING_CATEGORY(lcPropagator, "elyranur.sync.propagator", QtInfoMsg)
Q_LOGGING_CATEGORY(lcDirectory, "elyranur.sync.propagator.directory", QtInfoMsg)
Q_LOGGING_CATEGORY(lcCleanupPolls, "elyranur.sync.propagator.cleanuppolls", QtInfoMsg)
