...
{
    return appNameGUI() != QStringLiteral("Elyranur");
}
...
#else
    return QString::fromLatin1("https://docs.elyranur.com/desktop/%1.%2/").arg(MIRALL_VERSION_MAJOR).arg(MIRALL_VERSION_MINOR);
#endif
}
...
QString Theme::gitSHA1() const
{
    ...
    const QString githubPrefix(QLatin1String(
        "https://github.com/elyranur/desktop/commit/"));
    const QString gitSha1(QLatin1String(GIT_SHA1));
    devString = QCoreApplication::translate("elyranurTheme::about()",
...
QString Theme::about() const
{
    ...
    QString devString;
    //: Example text: "<p>Elyranur Desktop Client</p>"   (%1 is the application name)
...
{
    if (!Theme::isBranded()) {
        return QPixmap(Theme::hidpiFileName(QString(Theme::themePrefix) + "colored/wizard-elyranur.png"));
    }
