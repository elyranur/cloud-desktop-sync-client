/*
 * Copyright (C) by Oleksandr Zolotov <alex@elyranur.com>
 *
...
Q_LOGGING_CATEGORY(PROPAGATE_REMOVE_ENCRYPTED_ROOTFOLDER, "elyranur.sync.propagator.remove.encrypted.rootfolder")
