...
Q_LOGGING_CATEGORY(lcSignPublicKeyApiJob, "elyranur.sync.networkjob.sendcsr", QtInfoMsg)
Q_LOGGING_CATEGORY(lcStorePrivateKeyApiJob, "elyranur.sync.networkjob.storeprivatekey", QtInfoMsg)
Q_LOGGING_CATEGORY(lcCseJob, "elyranur.sync.networkjob.clientsideencrypt", QtInfoMsg)
