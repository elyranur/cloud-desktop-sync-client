/*
 * Copyright (C) by Kevin Ottens <kevin.ottens@elyranur.com>
 *
...
Q_LOGGING_CATEGORY(lcXAttrWrapper, "elyranur.sync.vfs.xattr.wrapper", QtInfoMsg)

namespace {
constexpr auto hydrateExecAttributeName = "user.elyranur.hydrate_exec";
...
bool OCC::XAttrWrapper::hasElyranurPlaceholderAttributes(const QString &path)
{
...
OCC::Result<void, QString> OCC::XAttrWrapper::addElyranurPlaceholderAttributes(const QString &path)
{
