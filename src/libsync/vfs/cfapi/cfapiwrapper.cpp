...
Q_LOGGING_CATEGORY(lcCfApiWrapper, "elyranur.sync.vfs.cfapi.wrapper", QtInfoMsg)
...
bool createSyncRootRegistryKeys(const QString &providerName, const QString &folderAlias, const QString &displayName, const QString &accountDisplayName, const QString &syncRootPath)
{
    ...
    // folder registry keys go like: Elyranur!S-1-5-21-2096452760-2617351404-2281157308-1001!user@elyranur.lan:8080!0, Elyranur!S-1-5-21-2096452760-2617351404-2281157308-1001!user@elyranur.lan:8080!1, etc. for each sync folder
