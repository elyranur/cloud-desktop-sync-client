...
Q_LOGGING_CATEGORY(lcCse, "elyranur.sync.clientsideencryption", QtInfoMsg)
Q_LOGGING_CATEGORY(lcCseDecryption, "elyranur.e2e", QtInfoMsg)
Q_LOGGING_CATEGORY(lcCseMetadata, "elyranur.metadata", QtInfoMsg)
