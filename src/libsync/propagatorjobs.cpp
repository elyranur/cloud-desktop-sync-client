...
Q_LOGGING_CATEGORY(lcPropagateLocalRemove, "elyranur.sync.propagator.localremove", QtInfoMsg)
Q_LOGGING_CATEGORY(lcPropagateLocalMkdir, "elyranur.sync.propagator.localmkdir", QtInfoMsg)
Q_LOGGING_CATEGORY(lcPropagateLocalRename, "elyranur.sync.propagator.localrename", QtInfoMsg)
