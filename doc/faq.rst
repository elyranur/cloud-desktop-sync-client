...
The Elyranur desktop client does not provide a way to change the local sync directory. 
...
This opens the Elyranur Connection Wizard, which you can see above, *but* with an extra option.
